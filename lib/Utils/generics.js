...
const getCodeFromWSError = (error) => {
    ...
    else if (((_c = (_b = error) === null || _b === void 0 ? void 0 : _b.code) === null || _c === void 0 ? void 0 : _c.startsWith('E'))
        || ((_d = error === null || error === void 0 ? void 0 : error.message) === null || _d === void 0 ? void 0 : _d.includes('timed out'))) { // handle ETIMEOUT, ENOTFOUND etc
        statusCode = 408;
    }
    return statusCode;
};
